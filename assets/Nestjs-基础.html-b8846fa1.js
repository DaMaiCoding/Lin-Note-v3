import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-dbe0aa30.js";const e={},p=t(`<h1 id="nestjs-基础" tabindex="-1"><a class="header-anchor" href="#nestjs-基础" aria-hidden="true">#</a> Nestjs-基础</h1><h2 id="ioc-控制反转-di-依赖注入-没懂" tabindex="-1"><a class="header-anchor" href="#ioc-控制反转-di-依赖注入-没懂" aria-hidden="true">#</a> IOC 控制反转 DI 依赖注入 (<code>没懂</code>)</h2><h3 id="什么是强耦合" tabindex="-1"><a class="header-anchor" href="#什么是强耦合" aria-hidden="true">#</a> 什么是强耦合</h3><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name"><span class="token constant">A</span></span> <span class="token punctuation">{</span>
