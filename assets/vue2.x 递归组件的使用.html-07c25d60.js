import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-4bc45b34.js";const p={},e=t(`<h1 id="vue2-x-递归组件的使用" tabindex="-1"><a class="header-anchor" href="#vue2-x-递归组件的使用" aria-hidden="true">#</a> Vue2.x 递归组件的使用</h1><h2 id="效果" tabindex="-1"><a class="header-anchor" href="#效果" aria-hidden="true">#</a> 效果</h2><p>![image-20230619153720228](./assets/Vue2.x 递归组件的使用/image-20230619153720228-1687160244772-1.png)</p><h2 id="实现" tabindex="-1"><a class="header-anchor" href="#实现" aria-hidden="true">#</a> 实现</h2><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token comment">&lt;!-- 递归组件 --&gt;</span>
