import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-dbe0aa30.js";const p={},e=t(`<h1 id="构建工具" tabindex="-1"><a class="header-anchor" href="#构建工具" aria-hidden="true">#</a> 构建工具</h1><h2 id="vue-router-有哪些变化" tabindex="-1"><a class="header-anchor" href="#vue-router-有哪些变化" aria-hidden="true">#</a> Vue-Router 有哪些变化?</h2><p><strong>引入方式变化, routes 属性加入强制判断</strong></p><p>如果页面上没有对应的命名式路由, 如果像推送到路由上去, 原先的做法会默认导航到默认路径 (&#39;/&#39;)</p><p>现在 4.x 以上版本不会有这个行为, 而是去加载一个空的组件, 且在控制台抛出异常</p><p><strong>不会再给默认路径添加 /, redirect重定向需要写全路径</strong></p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token comment">// router/index.js</span>
